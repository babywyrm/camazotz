...
<img src="https://img.shields.io/badge/coverage-99.6%25-10b981?style=flat-square" alt="99.6% coverage">
...
└──────────────┘     │  52 intentionally vulnerable labs    │
...
├── camazotz_modules/        # 52 vulnerability lab modules (LabModule subclasses)
...
├── tests/                   # 1479 tests, 99.6% coverage
...
make test           # run 1479 tests (99.6% coverage)
