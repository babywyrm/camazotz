...
<img src="https://img.shields.io/badge/modules-39_labs-dc2626?style=flat-square" alt="39 labs">
...
- **Threat Map** — `/threat-map` page with 7 category groups, 39 labs
...
- **QA checks for all 39 labs** — every lab covered in the QA harness
